    ...
    <header>
        <div class="header-area">
            <div class="header-left-sidebar">
                <div class="logo">
                    <a href="index.html"><img src="/ezone/assets/img/logo/logo.png" alt=""></a>
                </div>
                            ...
                            <li><a href="#">Latest <span>New</span></a>
                                <div class="mega-menu-dropdown mega-dropdown-width">
                                    ...
                                    <div class="mega-banner-img-2">
                                        <a href="single-product.html"><img src="/ezone/assets/img/bg/3.png" alt=""></a>
                                    </div>
                                </div>
                            </li>
                            <li><a href="#">Shop</a>
            ...
            <div class="header-right-sidebar">
                <div class="header-search-cart-login">
                    <div class="logo">
                        <a href="index.html">
                            <img src="/ezone/assets/img/logo/logo.png" alt="">
                        </a>
                    </div>
                ...
                <div class="slider-area ">
                    <div class="slider-active owl-carousel">
                        <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url(/ezone/assets/img/slider/15.jpg)">
                            ...
                            <div class="position-slider-img">
                                <div class="slider-img-1">
                                    <img src="/ezone/assets/img/slider/9.png" alt="">
                                </div>
                                <div class="slider-img-2">
                                    <img class="tilter" src="/ezone/assets/img/slider/7.png" alt="">
                                </div>
                                <div class="slider-img-3">
                                    <img src="/ezone/assets/img/slider/8.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url(/ezone/assets/img/slider/15.jpg)">
                            ...
                            <div class="position-slider-img">
                                ...
                                <div class="slider-img-4 slider-mrg">
                                    <img class="tilter" src="/ezone/assets/img/slider/10.png" alt="">
                                </div>
                                <div class="slider-img-3">
                                    <img src="/ezone/assets/img/slider/8.png" alt="">
                                </div>
        ...
        <div class="row no-gutters">
            <div class="col-md-4">
                <div class="single-banner">
                    <a href="#"><img src="/ezone/assets/img/banner/1.jpg" alt=""></a>
            ...
            <div class="col-md-4">
                <div class="single-banner">
                    <a href="#"><img src="/ezone/assets/img/banner/2.jpg" alt=""></a>
            ...
            <div class="col-md-4">
                <div class="single-banner">
                    <a href="#"><img src="/ezone/assets/img/banner/3.jpg" alt=""></a>
            ...
            <div class="row no-gutters">
                <div class="col-lg-6 col-xl-6">
                    <div class="banner-wrapper mrgn-r-4">
                        <a href="#"><img src="/ezone/assets/img/banner/4.jpg" alt=""></a>
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-12">
                            <div class="banner-wrapper mrgn-b-4">
                                <a href="#"><img src="/ezone/assets/img/banner/5.jpg" alt=""></a>
                        ...
                        <div class="col-lg-12">
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="banner-wrapper mrgn-r-4">
                                        <a href="#"><img src="/ezone/assets/img/banner/6.jpg" alt=""></a>
                                ...
                                <div class="col-lg-6">
                                    <div class="banner-wrapper">
                                        <a href="#"><img src="/ezone/assets/img/banner/7.jpg" alt=""></a>
        ...
        <div class="ptb-135 gray-bg">
            <div class="brand-logo-active owl-carousel">
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/1.png" alt="">
                </div>
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/2.png" alt="">
                </div>
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/1.png" alt="">
                </div>
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/3.png" alt="">
                </div>
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/4.png" alt="">
                </div>
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/5.png" alt="">
                </div>
                <div class="single-brand">
                    <img src="/ezone/assets/img/brand-logo/6.png" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row no-gutters">
                    <div class="col-md-12 col-lg-4 col-xl-4">
                        <div class="banner-wrapper mrgn-negative">
                            <a href="#"><img src="/ezone/assets/img/banner/8.jpg" alt=""></a>
                        ...
                        <div class="row no-gutters banner-mrg">
                            <div class="col-md-6">
                                <div class="banner-wrapper mrgn-b-5 mrgn-r-5 ">
                                    <img src="/ezone/assets/img/banner/9.jpg" alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-wrapper mrgn-b-5">
                                    <img src="/ezone/assets/img/banner/10.jpg" alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-wrapper mrgn-r-5">
                                    <img src="/ezone/assets/img/banner/11.jpg" alt="">
                                    <div class="banner-wrapper3-content">
                                        <a href="#">Shop Now</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="banner-wrapper">
                                    <img src="/ezone/assets/img/banner/12.jpg" alt="">
                                    <div class="banner-wrapper3-content">
                                        <a href="#">Shop Now</a>
                                    </div>
                                </div>
            ...
            <div class="instafeed-wrapper">
                <div class="instafeed-active owl-carousel">
                    <div class="instafeed-img">
                        <img src="/ezone/assets/img/instra/1.jpg" alt="">
                    </div>
                    <div class="instafeed-img">
                        <img src="/ezone/assets/img/instra/2.jpg" alt="">
                    </div>
                    <div class="instafeed-img">
                        <img src="/ezone/assets/img/instra/3.jpg" alt="">
                    </div>
                    <div class="instafeed-img">
                        <img src="/ezone/assets/img/instra/4.jpg" alt="">
                    </div>
                    <div class="instafeed-img">
                        <img src="/ezone/assets/img/instra/5.jpg" alt="">
                    </div>
                    <div class="instafeed-img">
                        <img src="/ezone/assets/img/instra/2.jpg" alt="">
                    </div>
